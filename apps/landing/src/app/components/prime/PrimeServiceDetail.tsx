      ...
      <section className="relative pt-10 pb-12 md:pt-14 md:pb-16 border-b border-white/5 overflow-hidden">
        ...
        <div className="container mx-auto px-6 max-w-5xl relative">
          <ScrollReveal>
            ...
            <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-slate-950/95 via-slate-900/85 to-slate-800/60 p-8 md:p-12 backdrop-blur-xl shadow-[0_24px_80px_rgba(0,0,0,0.45)]">
      ...
      <div className="container mx-auto px-6 max-w-5xl pb-20 space-y-12 md:space-y-14">
        ...
        <ScrollReveal delay={0.05}>
          <div className="grid lg:grid-cols-2 gap-6">
            <div className="rounded-2xl border border-red-500/15 bg-gradient-to-br from-red-950/35 to-slate-950/50 p-6 md:p-8 h-full">
            ...
            <div className="rounded-2xl border border-cyan-500/20 bg-gradient-to-br from-cyan-950/30 to-slate-950/50 p-6 md:p-8 h-full">
        ...
        <ScrollReveal delay={0.1}>
          <div className="grid lg:grid-cols-2 gap-6 md:gap-8">
            <div className="rounded-2xl border border-white/10 bg-slate-950/50 p-6 md:p-8">
        ...
        <ScrollReveal delay={0.12}>
          <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-slate-950/70 to-slate-900/50 p-6 md:p-8">
        ...
        <ScrollReveal delay={0.14}>
          <div className="rounded-3xl border border-cyan-500/25 bg-gradient-to-br from-slate-900/95 to-slate-800/80 p-8 md:p-10 text-center shadow-[0_20px_60px_rgba(34,211,238,0.08)]">
