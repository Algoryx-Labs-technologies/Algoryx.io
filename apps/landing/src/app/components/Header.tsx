      ...
      <nav className="container mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/algoryx-prime" className="text-gray-700 dark:text-gray-300 hover:text-cyan-500 dark:hover:text-cyan-400 transition-colors font-medium">Prime</Link>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-4">
            ...
            <Link to="/algoryx-prime" className="block text-gray-700 dark:text-gray-300 hover:text-cyan-500 dark:hover:text-cyan-400 transition-colors font-medium" onClick={() => setMobileMenuOpen(false)}>Prime</Link>
